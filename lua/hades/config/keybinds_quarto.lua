vim.api.nvim_create_autocmd({ "FileType", "BufEnter" }, {
  ...
  callback = function(ev)
    ...
    keymap("n", "<localleader>sc", send_cell, opts, "[q]uarto send cell")
    -- keymap("n", "<leader>sc", send_cell, opts, "[q]uarto send cell")
    ...
    keymap("n", "<leader>qI", insert_r_chunk, opts, "[I]nsert R chunk")
    keymap("n", "<localleader>qi", insert_py_chunk, opts, "[i]nsert PYTHON chunk")
    ...
    keymap("n", "<localleader>tp", new_terminal_python, opts, "new [p]ython terminal")
    keymap("n", "<localleader>ti", new_terminal_ipython, opts, "new [i]python terminal")
    ...
    if isModuleAvailable("otter") then
      keymap("n", "<localleader>qe", require("otter").export, opts, "[e]xport (otter)")
    end
