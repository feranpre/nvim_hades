...
keymap_buffer(0, "n", "<localleader>tnr", new_terminal_r, opts, "(Slime)[t]erminal [n]ew for [r]")
keymap_buffer(0, "n", "<localleader>tnp", new_terminal_python, opts, "(Slime)[t]erminal [n]ew for [p]ython")
...
if Molten_or_Slime == "slime" then
  ...
  keymap_buffer(0, "n", "<localleader>S", function()
...
-- keymap_buffer(0, "v", "<C-CR>", "<Plug>SlimeRegionSend<CR>", opts, "(Slime)[s]end region")
keymap_buffer(0, "n", "<localleader>sr", "<Plug>SlimeRegionSend<CR>", opts, "(Slime)[s]end [r]egion")
keymap_buffer(
  0,
  "n",
  "<localleader>sc",
